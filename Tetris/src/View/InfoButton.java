...
public class InfoButton extends JComponent {
    ...
    private void initImage() {
        try {
            infoNormal = ImageIO.read(getClass().getClassLoader().getResource("View/buttons/infonormal.jpg"));
            infoMouse = ImageIO.read(getClass().getClassLoader().getResource("View/buttons/infomouse.jpg"));
            infoClick = ImageIO.read(getClass().getClassLoader().getResource("View/buttons/infoclick.jpg"));
        } catch (IOException e) {
            e.getCause();
        }
    }
