...
public class MusicButton extends JComponent {
    ...
    private void loadImages() {
        try {
            onNormal = ImageIO.read(getClass().getClassLoader().getResource("View/buttons/onoff/onnormal.jpg"));
            onMouse = ImageIO.read(getClass().getClassLoader().getResource("View/buttons/onoff/onmouse.jpg"));
            onClick = ImageIO.read(getClass().getClassLoader().getResource("View/buttons/onoff/onclick.jpg"));
            offNormal = ImageIO.read(getClass().getClassLoader().getResource("View/buttons/onoff/offnormal.jpg"));
            offMouse = ImageIO.read(getClass().getClassLoader().getResource("View/buttons/onoff/offmouse.jpg"));
            offClick = ImageIO.read(getClass().getClassLoader().getResource("View/buttons/onoff/offclick.jpg"));
        } catch (IOException e) {
            e.getCause();
        }
    }
