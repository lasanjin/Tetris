...
/**
 * This class handles Sound Button action.
 */
public class SettingsButton extends JComponent {
    ...
    private void loadImages() {
        try {
            settingsNormal = ImageIO.read(getClass().getClassLoader().getResource("View/buttons/settingsnormal.jpg"));
            settingsMouse = ImageIO.read(getClass().getClassLoader().getResource("View/buttons/settingsmouse.jpg"));
            settingsClick = ImageIO.read(getClass().getClassLoader().getResource("View/buttons/settingsclick.jpg"));
        } catch (IOException e) {
            e.getCause();
        }
    }
